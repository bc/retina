...
##' @export
tear_markup_plot <- function(path_to_retina_data_folder, points=FALSE, csv_is_available = FALSE) {
    ##' helper function'
    ...
    if (csv_is_available){
        roi_object <- retistruct:::csv.read.dataset(path_to_retina_data_folder)
    } else {
